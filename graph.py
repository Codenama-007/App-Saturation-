...
# generated by claude 
# for checking whether the idea is already stored in the memory
...
# Striping part of LLM response to make it look less messsy
def strip_think(text: str) -> str:
    return re.sub(r"<think>.*?</think>", "", text, flags=re.DOTALL).strip()

# For providing the Query
...
# import the tools made in the tools.py and use them here 
...
# this part will help in suggesting the user features regarding what he is building that can help him stand out his product/project
